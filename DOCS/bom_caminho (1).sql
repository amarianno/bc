...
--
-- Máquina: localhost
-- Data de Criação: 07-Nov-2013 às 16:41
...
CREATE TABLE IF NOT EXISTS `ficha_cadastral` (
  ...
  `naturalidade` int(3) DEFAULT NULL,
  ...
  `pt_referencia` varchar(100) NOT NULL,
  ...
  `numero_comodos` int(3) NOT NULL,
  `renda` int(3) DEFAULT NULL,
  `outra_renda` int(3) DEFAULT NULL,
  `de_onde` varchar(100) NOT NULL,
  ...
  `objetivo_cadastro` varchar(200) NOT NULL,
  `visita` varchar(1) NOT NULL,
