<?php /* Smarty version 2.6.18, created on 2013-04-17 12:42:07
         compiled from menu_top.tpl */ ?>
<!-- MENU -->
<div id="menu">
    <!-- menu-holder -->
    <div id="menu-holder">
        ...
        <div class="wrapper">
            ...
            <ul id="nav" class="sf-menu">
                <li id="logo_buscartas_peq" style="display: none">
                ...
                <li style="float:right">
                    <a href="#"><?php echo $this->_tpl_vars['nome']; ?>
